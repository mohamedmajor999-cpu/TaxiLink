// Biais geographique : detecte une grande ville francaise dans une requete
// pour centrer la recherche Google Places autour (rayon 50km). Par defaut
// (aucune ville explicite), priorise la metropole Aix-Marseille-Provence.
