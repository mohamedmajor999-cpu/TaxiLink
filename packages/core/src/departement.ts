/**
 * Extraction du code departement francais a partir d'une adresse contenant
 * un code postal. Regles :
 *   - DOM (97xxx) → code a 3 chiffres : 971, 972, 973, 974, 975, 976, 977, 978
 *   - Corse : 20000-20199 → "2A" ; 20200-20999 → "2B"
 *   - Metropole : 2 premiers chiffres du code postal (01 a 95, sauf 20)
 * Retourne null si aucun code postal n'est trouve ou s'il est hors France.
 */
