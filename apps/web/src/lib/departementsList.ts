...
// Liste complete des departements francais (metropole + DOM).
export const ALL_DEPARTEMENTS: DepartementInfo[] = [
  ...
  { code: '973', name: 'Guyane' },                    { code: '974', name: 'La Réunion' },
  { code: '975', name: 'Saint-Pierre-et-Miquelon' },  { code: '976', name: 'Mayotte' },
  { code: '977', name: 'Saint-Barthélemy' },          { code: '978', name: 'Saint-Martin' },
]
