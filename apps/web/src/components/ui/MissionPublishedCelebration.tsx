...
export function MissionPublishedCelebration({ onDone, durationMs = 2500 }: Props) {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-[140px] h-[140px] rounded-full bg-emerald-500 flex items-center justify-center shadow-[0_16px_44px_rgba(16,185,129,0.4),0_0_0_8px_rgba(16,185,129,0.12)]"
