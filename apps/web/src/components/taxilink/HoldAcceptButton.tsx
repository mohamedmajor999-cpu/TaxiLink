...
export function HoldAcceptButton({
  ...
  return (
    <button
      ...
      className={`relative w-full h-14 px-6 rounded-xl overflow-hidden flex items-center justify-center gap-2 font-medium text-sm select-none transition-transform duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${baseColors} ${isPressing ? 'scale-[0.98]' : ''}`}
    >
