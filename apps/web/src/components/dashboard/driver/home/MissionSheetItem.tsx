...
export function MissionSheetItem({ mission, selected, userCoords, onSelect }: Props) {
  ...
  return (
    <button
      ...
      className={`w-full text-left rounded-2xl bg-paper dark:bg-night-surface transition-colors ${
        selected
          ? 'border-2 border-ink dark:border-night-brand shadow-[0_6px_16px_rgba(0,0,0,0.1)] p-[13px]'
          : 'border border-warm-200 dark:border-night-border hover:border-warm-300 p-3.5'
      }`}
    >
      <div className="flex gap-2.5 items-start">
        ...
        <div className="text-right shrink-0 flex flex-col items-end gap-0.5">
          <div className="text-[16px] font-black text-ink dark:text-night-brand tabular-nums leading-tight">
