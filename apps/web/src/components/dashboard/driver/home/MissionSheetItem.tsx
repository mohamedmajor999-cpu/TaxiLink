  ...
  return (
    <button
      ...
      className={`w-full text-left rounded-2xl bg-paper transition-colors ${
        selected
          ? 'border-2 border-ink shadow-[0_6px_16px_rgba(0,0,0,0.1)] p-[15px]'
          : 'border border-warm-200 hover:border-warm-300 p-4'
      }`}
    >
      <div className="flex gap-3 items-start">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-2 flex-wrap pl-[26px]">
        ...
        <div className="text-right shrink-0 flex flex-col items-end gap-0.5">
          <div className="text-[17px] font-black text-ink tabular-nums leading-tight">
