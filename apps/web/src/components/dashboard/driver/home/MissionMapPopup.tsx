...
export function MissionMapPopup({ mission, userCoords, onAccept, onShowDetail, onClose }: Props) {
  ...
  return (
    <div
      ...
      className="absolute left-3 right-3 bottom-3 z-[600] rounded-2xl bg-paper border border-warm-200 shadow-[0_-8px_30px_rgba(0,0,0,0.18)] p-4 motion-safe:animate-[popup-in_280ms_cubic-bezier(0.34,1.56,0.64,1)]"
      style={{
    ...
    >
      ...
      <button
        ...
        onClick={onClose}
        aria-label="Fermer"
        className="absolute top-2.5 right-2.5 w-7 h-7 rounded-full bg-warm-100 hover:bg-warm-200 flex items-center justify-center text-ink transition-colors"
      >
      ...
      <div className="flex gap-3 items-start pr-8">
        <div className="flex-1 min-w-0">
          <div className="grid grid-cols-[14px_1fr] gap-x-3 items-center">
            ...
            <p className="text-[15px] font-semibold text-ink truncate leading-[1.3]">{mission.departure}</p>
        ...
        <div className="text-right shrink-0 flex flex-col items-end gap-1">
          <div className="text-[20px] font-black text-ink tabular-nums leading-tight">
