...
export function PostedBoostStrip({ hoursWaiting, busy, onBoostPrice }: Props) {
  return (
    <div className="mt-2">
      ...
      <div className="mt-2">
        <button
          ...
          disabled={busy}
          className="w-full h-8 rounded-lg bg-ink text-paper text-[11px] font-extrabold disabled:opacity-50 hover:bg-warm-800 transition-colors inline-flex items-center justify-center gap-1"
        >
