  ...
  return (
    ...
    >
      <Pressable
        ...
        // hitSlop pour les rows menu : meme si la rangee est grande, certaines
        // zones (bord exterieur, ripple lent) peuvent rater le tap. Le user
        // reportait que "Se deconnecter" et theme demandaient parfois 2 taps.
        hitSlop={{ top: 6, bottom: 6, left: 6, right: 6 }}
        android_ripple={{ color: tone === 'danger' ? 'rgba(220,38,38,0.10)' : 'rgba(0,0,0,0.06)' }}
        style={{
          flexDirection: 'row',
          alignItems: 'center',
          gap: 12,
