    ...
    >
      ...
      {c.type === 'CPAM' && (
        <PosterCpamBlock
          ...
          pickupBulletin={c.pickupBulletin}
          setPickupBulletin={c.setPickupBulletin}
          pickupBonTransport={c.pickupBonTransport}
          setPickupBonTransport={c.setPickupBonTransport}
        />
      )}
