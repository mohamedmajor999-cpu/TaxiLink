...
export function Icon({ name, size = 18, color = '#0F0F0F', strokeWidth = 2 }: Props) {
  ...
  switch (name) {
    ...
    case 'car':
      return (
        <Svg {...common}>
          <Path d="M5 17h14M5 17l1.5-5h11l1.5 5M5 17v3h3v-3M16 20h3v-3" {...stroke} />
          <Circle cx="8" cy="17" r="1.5" {...stroke} />
          <Circle cx="16" cy="17" r="1.5" {...stroke} />
        </Svg>
      );
    case 'users-plus':
      return (
